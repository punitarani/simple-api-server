...
// TimezonesList is a list of all timezones
//
// This list is generated from the keys of the Timezones map
// This list is sorted alphabetically
var TimezonesList = getTimezones()

// getTimezones returns a sorted list of all timezones
func getTimezones() []string {
	var tzList = make([]string, 0, len(Timezone))
...
// Timezone is a map of timezone Name and Offset.
//
//	Name (string) is the timezone name.
//	Offset (string) is the timezone offset (e.g. "-05:00").
//	Data is from https://en.wikipedia.org/wiki/List_of_tz_database_time_zones#List.
